<template>
    <div class="header-container fixed-top">
        <header v-bind:class="getStyleForNavBar">
            <a href="javascript:void(0);"
               class="sidebarCollapse"
               v-on:click="openOrCloseSidebar"
            ...
            <ul class="navbar-item flex-row ml-auto">
                                ...
                                <div class="">
                                    <div class="media notification-new">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="message-text">Some quick example text to build the
                                                notification ..</p>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1" v-bind:class="getStyleForNavBar">
                    <a href="javascript:void(0);"
                       class="nav-link dropdown-toggle user"
                       v-on:click="openUserProfileDropdown = !openUserProfileDropdown"
...
export default {
    ...
    computed: {
        ...
        /**
         * Выдать стиль для открытие или закрытие UserProfileDropdown
         *
         * @returns {string}
         */
        styleForDropdown() {
            return this.openUserProfileDropdown ? 'show' : '';
        },
    }
}
</script>
