        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories ps ps--active-y" id="accordionExample">
                <li class="menu active">
                    ...
                    <ul class="collapse submenu recent-submenu list-unstyled mini-recent-submenu" id="dashboard"
                ...
                <div class="ps__rail-x" style="left: 0px; bottom: -8px;">
                    <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                </div>
                <div class="ps__rail-y" style="top: 8px; height: 440px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 2px; height: 137px;"></div>
                </div>
            </ul>
